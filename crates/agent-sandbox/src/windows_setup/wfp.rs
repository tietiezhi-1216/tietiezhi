...
const SUBLAYER_NAME: &str = "Tietiezhi Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for Tietiezhi Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are Tietiezhi-owned identities; do not regenerate them unless we
// intentionally want to orphan old objects and create a new WFP namespace.
const PROVIDER_KEY: GUID = GUID::from_u128(0xcd9dba2c_210c_4a11_bf2c_939d8462bac8);
const SUBLAYER_KEY: GUID = GUID::from_u128(0xefea8c70_8b16_4ff6_9426_901702d710df);

/// Installs the persistent Tietiezhi WFP filters for `account`.
///
...
/// Ensures the persistent Tietiezhi WFP provider exists.
...
/// Ensures the persistent Tietiezhi sublayer exists under the Tietiezhi provider.
