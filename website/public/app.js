...
(function () {
  ...
  const I18N = {
    "zh-CN": {
      "meta.title": "铁铁汁 Tietiezhi — AI 模型中转客户端",
      "nav.howitworks": "工作原理",
      "nav.features": "功能特性",
      "nav.download": "下载",
      "nav.faq": "常见问题",
      "nav.cta": "下载客户端",
      "hero.title": `连接万物的 <span class="${HL}">AI 中转客户端</span>`,
      "hero.desc": "配置中转站 baseURL 与 API Key，即刻使用聊天等能力。密钥由系统钥匙串安全保管，绝不明文落盘。支持 Windows 与 macOS。",
      "hero.cta1": "立即下载",
      "hero.cta2": "了解功能",
      "steps.title": "三步开始使用",
      "steps.1.t": "填写接入配置",
      "steps.1.d": "在「接入配置」填入中转站 baseURL 与 API Key，一键测试连通。",
      "steps.2.t": "选择模型",
      "steps.2.d": "从中转站支持的模型中选择，随时按需切换。",
      "steps.3.t": "开始对话",
      "steps.3.d": "发送消息，实时流式返回，畅快交流。",
      "features.title": "功能特性",
      "features.1.t": "OpenAI 兼容接入",
      "features.1.d": "兼容 <code>/v1/chat/completions</code> 标准接口，填好 baseURL 与 API Key 即可对接主流中转站，无需额外适配。",
      "features.2.t": "密钥安全存储",
      ...
      "faq.title": "常见问题",
      "faq.1.q": "铁铁汁是什么？",
      "faq.1.a": "铁铁汁是 AI 模型中转站的官方桌面客户端，帮助你便捷地接入并使用中转站提供的 AI 能力。",
      "faq.2.q": "支持哪些操作系统？",
      ...
      "footer.tagline": "以万物互联为核心的 AI 生态客户端",
      "footer.rights": "© 2026 铁铁汁 Tietiezhi. 保留所有权利。",
    },
    en: {
      "meta.title": "Tietiezhi — AI Model Gateway Client",
      "nav.howitworks": "How it works",
      "nav.features": "Features",
      "nav.download": "Download",
      "nav.faq": "FAQ",
      "nav.cta": "Download app",
      "hero.title": `The <span class="${HL}">AI gateway client</span> that connects everything`,
      "hero.desc": "Set your gateway baseURL and API Key to start chatting in seconds. Keys are secured in your system keychain — never written to disk in plaintext. Available for Windows and macOS.",
      "hero.cta1": "Download now",
      "hero.cta2": "Explore features",
      "steps.title": "Get started in three steps",
      "steps.1.t": "Add your gateway",
      "steps.1.d": "Enter the gateway baseURL and API Key under “Provider”, then test the connection in one click.",
      "steps.2.t": "Pick a model",
      "steps.2.d": "Choose from the models your gateway offers and switch anytime.",
      "steps.3.t": "Start chatting",
      "steps.3.d": "Send a message and watch replies stream back in real time.",
      "features.title": "Features",
      "features.1.t": "OpenAI-compatible",
      "features.1.d": "Works with the standard <code>/v1/chat/completions</code> API — just set baseURL and API Key to connect to popular gateways, no extra adapters.",
      ...
      "faq.1.a": "Tietiezhi is the official desktop client for AI model gateways, making it easy to connect to and use the AI capabilities your gateway provides.",
      ...
      "footer.tagline": "An AI ecosystem client built around universal connectivity",
      "footer.rights": "© 2026 Tietiezhi. All rights reserved.",
    },
    ja: {
      "meta.title": "Tietiezhi — AI モデル中継クライアント",
      "nav.howitworks": "使い方",
      "nav.features": "機能",
      "nav.download": "ダウンロード",
      "nav.faq": "よくある質問",
      "nav.cta": "ダウンロード",
      "hero.title": `すべてをつなぐ <span class="${HL}">AI 中継クライアント</span>`,
      "hero.desc": "中継サーバーの baseURL と API キーを設定するだけで、すぐにチャットを利用できます。キーはシステムのキーチェーンで安全に保管され、平文で保存されることはありません。Windows と macOS に対応。",
      "hero.cta1": "今すぐダウンロード",
      "hero.cta2": "機能を見る",
      "steps.title": "3 ステップで始める",
      "steps.1.t": "接続設定を入力",
      "steps.1.d": "「接続設定」で中継サーバーの baseURL と API キーを入力し、ワンクリックで接続テスト。",
      "steps.2.t": "モデルを選択",
      "steps.2.d": "中継サーバーが提供するモデルから選び、いつでも切り替え可能。",
      "steps.3.t": "チャットを開始",
      "steps.3.d": "メッセージを送信すると、リアルタイムでストリーミング表示されます。",
      "features.title": "機能",
      "features.1.t": "OpenAI 互換",
      "features.1.d": "標準の <code>/v1/chat/completions</code> API に対応。baseURL と API キーを設定するだけで主要な中継サーバーに接続でき、追加の設定は不要です。",
      ...
      "faq.1.a": "Tietiezhi は AI モデル中継サーバーの公式デスクトップクライアントで、中継サーバーが提供する AI 機能に簡単に接続して利用できます。",
      "faq.2.q": "対応 OS は？",
      ...
      "footer.tagline": "万物接続を軸にした AI エコシステムクライアント",
      "footer.rights": "© 2026 Tietiezhi. All rights reserved.",
    },
    ko: {
      "meta.title": "Tietiezhi — AI 모델 중계 클라이언트",
      "nav.howitworks": "사용 방법",
      "nav.features": "기능",
      "nav.download": "다운로드",
      "nav.faq": "자주 묻는 질문",
      "nav.cta": "다운로드",
      "hero.title": `모든 것을 연결하는 <span class="${HL}">AI 중계 클라이언트</span>`,
      "hero.desc": "중계 서버의 baseURL과 API 키만 설정하면 바로 채팅 등을 사용할 수 있습니다. 키는 시스템 키체인에 안전하게 보관되며 평문으로 저장되지 않습니다. Windows와 macOS를 지원합니다.",
      "hero.cta1": "지금 다운로드",
      "hero.cta2": "기능 살펴보기",
      "steps.title": "세 단계로 시작하기",
      "steps.1.t": "접속 설정 입력",
      "steps.1.d": "‘접속 설정’에서 중계 서버의 baseURL과 API 키를 입력하고 원클릭으로 연결 테스트.",
      "steps.2.t": "모델 선택",
      "steps.2.d": "중계 서버가 제공하는 모델 중에서 선택하고 언제든 전환하세요.",
      "steps.3.t": "대화 시작",
      "steps.3.d": "메시지를 보내면 실시간 스트리밍으로 응답이 표시됩니다.",
      "features.title": "기능",
      "features.1.t": "OpenAI 호환",
      "features.1.d": "표준 <code>/v1/chat/completions</code> API를 지원합니다. baseURL과 API 키만 설정하면 주요 중계 서버에 연결되며 별도 설정이 필요 없습니다.",
      ...
      "faq.title": "자주 묻는 질문",
      "faq.1.q": "Tietiezhi란?",
      "faq.1.a": "Tietiezhi는 AI 모델 중계 서버의 공식 데스크톱 클라이언트로, 중계 서버가 제공하는 AI 기능에 쉽게 연결하여 사용할 수 있습니다.",
      ...
      "footer.tagline": "만물 연결을 핵심으로 하는 AI 생태계 클라이언트",
      "footer.rights": "© 2026 Tietiezhi. All rights reserved.",
    },
  };
